...
enum FeedChartID: String {
    ...
    case casesByEpiWeek = "by_week_case"
    ...
    case casesByAgeGroup = "dengue_affected_by_age_group"
    case deathsByAgeGroup = "dengue_death_by_age_group"
    case casesByGender = "dengue_affected_by_gender"
    case deathsByGender = "dengue_death_by_gender"
}
